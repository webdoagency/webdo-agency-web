      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((benefit, index) => (
            <Card key={index} className="neumorphic-card neumorphic-3d p-4 h-32">
              <CardContent className="p-0 flex items-center gap-3">
                <div className="w-10 h-10 neumorphic rounded-2xl flex items-center justify-center flex-shrink-0">
        ...
        <div className="text-center mt-16">
          <div className="neumorphic-card rounded-3xl p-8 max-w-2xl mx-auto neumorphic-3d">
            ...
            <Button variant="hero" size="lg" onClick={scrollToContact} className="hover-neumorphic">
              Get Started Today
            </Button>
          </div>
        </div>
